...
// Adjusted position — slightly to the right & a bit below
const modalTop = rect.top - chatRect.top + scrollOffset + 6; // 6px below bubble
const modalLeft = rect.left - chatRect.left + rect.width + 12; // 12px to the right
